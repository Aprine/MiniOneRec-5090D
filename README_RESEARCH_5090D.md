...
<img src="./assets/logo.png" width="460" alt="MiniOneRec logo">

# MiniOneRec-5090D

### Compute-Efficient Generative Recommendation with Qwen2.5-3B
...
Single-GPU reproduction, diagnosis, and lightweight extension of
[MiniOneRec](https://github.com/AkaliKong/MiniOneRec) for semantic-ID-based
generative recommendation.

[Overview](#overview) | [Method](#research-pipeline) | [Results](#current-results) | [Reproduction](#reproduction) | [Roadmap](#research-roadmap)
...
```text
MiniOneRec/
|-- README.md                         # Upstream MiniOneRec documentation
|-- README_RESEARCH_5090D.md          # This research overview
...
upstream [README](./README.md). Compact local experiment manifests are preserved
