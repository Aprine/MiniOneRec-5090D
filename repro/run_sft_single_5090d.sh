...
SAMPLE="${SAMPLE:-1024}"
EPOCHS="${EPOCHS:-1}"
OUTPUT_DIR="${OUTPUT_DIR:-output_dir/qwen25_3b_${CATEGORY}_single5090d_sft}"
...
python -u sft.py \
  ...
  --wandb_project "" \
  --wandb_run_name "qwen25-3b-single5090d-sft" \
  --category "${CATEGORY}" \
...
echo "SFT checkpoint: ${OUTPUT_DIR}/final_checkpoint"
